...
var schema = Steam.Internal = ProtoBuf.protoFromFile(__dirname + '/protobufs/steamclient/steammessages_clientserver.proto').build();

Steam.GC = {
  // generated from dota/steammessages.proto
  Internal: ProtoBuf.protoFromFile(__dirname + '/protobufs/dota/steammessages.proto').build()
};
  ...
  if (eMsg == EMsg.ChannelEncryptResponse) {
    ...
    header = schema.MsgHdrProtoBuf.serialize({
      ...
      proto: {
        ...
        steamid: Long.fromString(this.steamID),
...
handlers[EMsg.ChannelEncryptResult] = function(data) {
  ...
  console.log(new schema.CMsgClientLogon(this._logOnDetails).toBuffer())
